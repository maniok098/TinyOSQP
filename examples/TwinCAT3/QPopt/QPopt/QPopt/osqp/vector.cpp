...
OSQPVectorf* OSQPVectorf_malloc(OSQPInt length) {
  ...
  if (b) {
    b->length = length;
    if (length) {
      b->values = (OSQPFloat*)c_malloc(length * sizeof(OSQPFloat));
      if (!(b->values)) {
        c_free(b);
        b = OSQP_NULL;
      }
...
OSQPVectori* OSQPVectori_malloc(OSQPInt length) {
  ...
  if (b) {
    b->length = length;
    if (length) {
      b->values = (OSQPInt*)c_malloc(length * sizeof(OSQPInt));
      if (!(b->values)) {
        c_free(b);
        b = OSQP_NULL;
      }
...
OSQPVectorf* OSQPVectorf_calloc(OSQPInt length) {
  ...
  if (b) {
    b->length = length;
    if (length) {
      b->values = (OSQPFloat*)c_calloc(length, sizeof(OSQPFloat));
      if (!(b->values)) {
        c_free(b);
        b = OSQP_NULL;
      }
...
OSQPVectori* OSQPVectori_calloc(OSQPInt length) {
  ...
  if (b) {
    b->length = length;
    if (length) {
      b->values = (OSQPInt*)c_calloc(length, sizeof(OSQPInt));
      if (!(b->values)) {
        c_free(b);
        b = OSQP_NULL;
      }
