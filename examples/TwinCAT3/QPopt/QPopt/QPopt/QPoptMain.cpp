...
class CQPoptCtrl : public ITcOCFCtrlImpl<CQPoptCtrl, CQPoptClassFactory>
{
public:
	CQPoptCtrl() {};
	virtual ~CQPoptCtrl() {};
...
{
	HRESULT hr = E_FAIL;
	TRACE("QPopt: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CQPoptCtrl>;
